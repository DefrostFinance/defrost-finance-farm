...
contract DefrostReflect is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    /// FinNexus total tokens supply
    uint256 constant public MAX_TOTAL_TOKEN_AMOUNT = 100000000 ether;//total
    ...
    constructor (
        ...
        _tTotal = MAX_TOTAL_TOKEN_AMOUNT;
        _rTotal = (MAX - (MAX % _tTotal));

        _rOwned[initHolder] = _rTotal;
        emit Transfer(address(0), initHolder, _tTotal);
    }
