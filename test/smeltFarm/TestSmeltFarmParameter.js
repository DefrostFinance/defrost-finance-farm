...
//let INTEREST_RATE = new BN("1").plus(new BN(0.002));//日 2/1000
//let DIV24= new BN("1").div(24);//div one day 24 hours
//INTEREST_RATE = Math.pow(INTEREST_RATE,DIV24) - 1;
//console.log("INTEREST_RATE",INTEREST_RATE);

let INTEREST_RATE = new BN(0.002).times(new BN("1000000000000000000000000000"));

console.log("INTEREST_RATE "+INTEREST_RATE.toString(10));

let H2O_PER_MONTH = web3.utils.toWei('10000', 'ether');
let H2O_PER_DAY = new BN(H2O_PER_MONTH.toString(10)).div(new BN(30));
console.log("h2o reward per day=",H2O_PER_DAY.toString(10));
...
//set phxfarm///////////////////////////////////////////////////////////
  ...
  {
      let msgData = farminst.contract.methods.setInterestInfo(INTEREST_RATE, 3600*24).encodeABI();
      console.log("singature data: ",msgData.toString(16));
  }
