...
const MeltToken = artifacts.require("DefrostReflect");
...
/////////////////////////////reward token///////////////////////////////////////////
  melt = await MeltToken.new("melt token","melt",18,10,accounts[0]);
//set phxfarm///////////////////////////////////////////////////////////
...
//=====================================================================================
      ...
      let msgData = teamReward.contract.methods.addAdmin(farmproxyinst.address).encodeABI();
...
///////////////////////test setting/////////////////////////////////////////////////////
   ...
   res = await melt.transfer(farmproxyinst.address,VAL_1M,{from:accounts[0]});
   assert.equal(res.receipt.status,true);
